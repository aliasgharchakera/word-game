...
pygame.draw.rect(DISPLAYSURF, (81,81,81), menu1)
pygame.draw.rect(DISPLAYSURF, (81,81,81), menu2)
pygame.draw.rect(DISPLAYSURF, (81,81,81), menu3)

#Draws light grey ovals 
#ovals on top of rectangles
pygame.draw.ellipse(DISPLAYSURF, (81,81,81), title)
pygame.draw.ellipse(DISPLAYSURF, (142,142,142), menu1)
pygame.draw.ellipse(DISPLAYSURF, (142,142,142), menu2)
pygame.draw.ellipse(DISPLAYSURF, (142,142,142), menu3)
...
while True: 
    ...
    for event in pygame.event.get():
        if event.type == VIDEORESIZE:
            ...
            pygame.draw.rect(DISPLAYSURF, (139,139,0), menu1)
            pygame.draw.rect(DISPLAYSURF, (139,139,0), menu2)
            pygame.draw.rect(DISPLAYSURF, (139,139,0), menu3)

            #Draws blue ovals on top of the rectangles.
            pygame.draw.ellipse(DISPLAYSURF, (139,139,0), title)
